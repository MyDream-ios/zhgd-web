      ...
      <div class="procedure">
        ...
        >
          ...
          <div class="border" :class="contract.workConfirm.hg=='合格'?'border-green':'border-red'" v-if="contract.workConfirm">
            ...
            <span v-if="contract.workConfirm" id="roateBfb1">{{contract.workConfirm.bfb}}</span>
          </div>
        </div>
      </div>
      <!-- 退场手续签订 -->
      <div class="contract">
        ...
        >
          <div class="border" :class="contract.entrance.hg=='合格'?'border-green':'border-red'" v-if="contract.entrance">
            ...
            <span v-if="contract.entrance" id="roateBfb2">{{contract.entrance.bfb}}</span>
          </div>
        </div>
      </div>
      <!-- 劳动合同签订 -->
      <div class="safety">
        ...
        >
          <div class="border" :class="contract.contract.hg=='合格'?'border-green':'border-red'" v-if="contract.contract">
            ...
            <span v-if="contract.contract" id="roateBfb3">{{contract.contract.bfb}}</span>
          </div>
        </div>
      </div>
      <!-- 两制确认书签订 -->
      <div class="information">
        ...
        <div
          ...
          <div class="border" :class="contract.exit_pdf.hg=='合格'?'border-green':'border-red'" v-if="contract.exit_pdf">
            ...
            <span v-if="contract.exit_pdf" id="roateBfb4">{{contract.exit_pdf.bfb}}</span>
          </div>
        </div>
      </div>
    </div>
