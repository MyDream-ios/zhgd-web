        ...
        <div class="side-nav">
            <ul>
                ...
                <li @click="activeShow='/systemLocation_home'">
                    <router-link to="/systemLocation_home" :class="activeShow=='/systemLocation'||activeShow=='/systemLocation_home'?'active':''">
                        <div class="icon real-timeIcon"></div>
                        <span>实时监控</span>
                    </router-link>
                </li>
                <li @click="activeShow='/systemLocation_search'">
                    <router-link to="/systemLocation_search" :class="activeShow=='/systemLocation_search'?'active':''">
                        <div class="icon searchIcon"></div>
                        <span>搜索查询</span>
                    </router-link>
                </li>
                <li @click="activeShow='/systemLocation_history'">
                    <router-link to="/systemLocation_history" :class="activeShow=='/systemLocation_history'?'active':''">
