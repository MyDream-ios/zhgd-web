      ...
      <div class="left-main">
        ...
        <div class="button-box">
          ...
          <div class="botton-button">
            <a class="alarm" @click="alarmShow=true,selectUserAlarms('today')">
              <i class="icon"></i>
              设备报警
            </a>
          </div>
              ...
              <div class="top-box">
                ...
                <div class="left-box">
                  ...
                  <ul v-if="productTable.length>0">
                    <li>高支模：{{deviceName}}</li>
                    <!--<li>X方向：{{productTable[productTable.length-1].strainFrequency}}°</li>-->
                    <!--<li>Y方向：{{productTable[productTable.length-1].strainTemperature}}°</li>-->
                  </ul>
                </div>
                <!-- 当日数据趋势图 -->
